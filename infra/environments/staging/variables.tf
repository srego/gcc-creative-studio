...
variable "gcp_region" {
  type        = string
  description = "The GCP region for the staging environment. Defaults to us-central1."
  default     = "us-central1"
}
...
variable "github_branch_name" {
  type        = string
  description = "The branch name to trigger builds from (e.g. develop or staging)."
}
